...
public class BoardRenderer extends MapRenderer {
    ...
    HashMap<Player, Integer> renderedItems = new HashMap<>();
    ...
    public void render(MapView map, MapCanvas canvas, Player player) {
    	int foundItems = game.getBoard(player).getFoundItems();
    	if(renderedItems.getOrDefault(player, -1) == foundItems)
    		return;
        ...
        if(player.getName().equals("hahah")) {
        ...
        renderedItems.put(player, foundItems);
    }
